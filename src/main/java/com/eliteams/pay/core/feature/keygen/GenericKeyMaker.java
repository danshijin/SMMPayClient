package com.eliteams.pay.core.feature.keygen;
...
public class GenericKeyMaker {
    ...
    private byte[] generateKeyBytes(int licenseType, int productId, int minorVersion, int majorVersion,
    ...
    public String generateKey(BigInteger privKey, BigInteger pubKey, int licenseType, int productId, int minorVersion,
                              int majorVersion, String userName) {
