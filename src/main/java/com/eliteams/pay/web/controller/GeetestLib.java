...
public class GeetestLib {
    ...
    public String getFailPreProcessRes() {
        ...
        return String.format("{\"success\":%s,\"gt\":\"%s\",\"challenge\":\"%s\"}", 0, this.getCaptchaId(),
                this.getChallengeId());
    }
    ...
    public String getSuccessPreProcessRes() {
        return String.format("{\"success\":%s,\"gt\":\"%s\",\"challenge\":\"%s\"}", 1, this.getCaptchaId(),
                this.getChallengeId());
    }
    ...
    public void saveValidateLog(String challenge, String validate, String seccode, String sdkResult) {
        ...
        String logFormat = String.format("date:%s,challenge:%s,validate:%s,seccode:%s,sdkResult:%s", date, challenge,
    ...
    public String getGtFrontSource() {
        ...
        String frontSource = String.format("<script type=\"text/javascript\" src=\"%s/get.php?" + "gt=%s&challenge=%s",
                base_path, this.captchaId, this.challengeId);
    ...
    public boolean validateRequest(HttpServletRequest request) {
        ...
        boolean gtResult = this.validate(request.getParameter(this.fn_geetest_challenge),
                request.getParameter(this.fn_geetest_validate), request.getParameter(this.fn_geetest_seccode));
    ...
    public String failbackValidateRequest(HttpServletRequest request) {
        ...
        gtlog(String
                .format("decode----ans:%s,bg_idx:%s,grp_idx:%s", decodeAns, decodeFullBgImgIndex, decodeImgGrpIndex));
